...
== Installation
****
En tant qu'utilisateur il y a juste besoin d'une connexion internet et d'un navigateur web. Il n'y a pas besoin d'installer de logiciel supplémentaire.

En tant que propriétaire du serveur il faut suivre les étapes suivantes : 

- Installer docker
- Lancer le create.bat pour un serveur windows ou le create.sh pour un serveur unix
****
