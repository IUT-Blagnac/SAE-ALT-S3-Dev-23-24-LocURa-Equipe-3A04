...
|         | Cahier de tests | https://github.com/IUT-Blagnac/SAE-ALT-S3-Dev-23-24-LocURa-Equipe-3A04/blob/master/Doc/CahierDeTest.adoc[Cahier de tests] | Donne les différents tests que l'on a pu effectuer
