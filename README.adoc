...
| Sem.4 (22/01 - 29/01       | 3ème Sprint | Sprint 3 | Sprint 3 |  [Sprint 3] | La colonne User Stories représente les User stories à développer durant le sprint
